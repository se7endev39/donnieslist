                    ...
                    <div className="info">
                      <div className="sec-user-info">
                        <div className="text-left">
                          <h3 className="title-user-info">Patrick H.</h3>
                        </div>
                        <div className="text-left">
                          <i
                            className="fa fa-mobile fa-cs-mobile"
                            aria-hidden="true"
                          ></i>
                          &nbsp; +1 (209) 568-7870
                        </div>
                        <div className="text-left">
                          ...
                          ></i>
                          &nbsp;
                          <a href="mailto:patrickhaledonnieslist@gmail.com">
                            patrickhaledonnieslist@gmail.com
                          </a>
                        </div>
                      </div>
                      <div className="sec-user-info">
                        <div className="text-left">
                          <h3 className="title-user-info">Donny D.</h3>
                        </div>
                        <div className="text-left">
                          <i
                            className="fa fa-mobile fa-cs-mobile"
                        ...
                        <div className="text-left">
                          ...
                          ></i>
                          &nbsp;
                          <a href="mailto:donnydey@gmail.com">
                            donnydey@gmail.com
                          </a>
                        </div>
                      </div>
