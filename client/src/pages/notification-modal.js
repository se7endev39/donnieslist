...
class NotificationModal extends Component {
  ...
  onToken(stripeToken) {
    try {
      ...
      //this.props.rechargeVideoSession({stripeToken, expertSlug, userEmail, amount}).then(
      this.props
        .addMoneyToWallet({ stripeToken, expertSlug, userEmail, amount })
        .then(
          (response) => {
            console.log("response: " + JSON.stringify(response));
          },
          ...
          <div className="modal-content">
            ...
            <div className="modal-body text-center">
              ...
              <div className="scheduleDiv" style={{ marginBottom: "10px" }}>
                Please select date from the calendar you want to spend with
                expert
              </div>
              ...
              <div className="form-group row">
                <div
                  style={{ display: "none" }}
                  className="col-md-12 scheduleSuccess"
                >
              ...
              <div
                dangerouslySetInnerHTML={{ __html: this.state.responseTextMsg }}
              />
            </div>
            <div className="modal-footer scheduleDiv">
              <div className="bootstrap-dialog-footer">
                <div className="bootstrap-dialog-footer-buttons text-center">
                  {/* <StripeCheckout token={this.onToken.bind(this)} stripeKey="pk_test_s744wYvqQUrpqsXGLnUBUFRw" panelLabel="Pay Now!" name="Donny's List Wallet Money"> <a href="#!" className="btn btn-primary">Add Money to Wallet</a></StripeCheckout>  */}
