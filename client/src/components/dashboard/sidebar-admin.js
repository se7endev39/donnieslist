        ...
        <ul className="nav nav-sidebar" id="menu">
          <li>
            ...
            >
              ...
              <span className="collapse in hidden-xs">
                Users Management <span className="caret"></span>
              </span>
            </a>
            <ul className="nav nav-stacked collapse" id="item1">
              <li>
                <Link to="/dashboard/userslist">List Users</Link>
              </li>
              <li>
                <Link to="/dashboard/create-expert">Create Expert</Link>
              </li>
            </ul>
          </li>
          <li>
            ...
            >
              <i className="fa fa-list"></i>
              <span className="collapse in hidden-xs">
                Session Management <span className="caret"></span>
              </span>
            </a>
            <ul className="nav nav-stacked collapse" id="item2">
              <li>
                <Link to="/dashboard/sessionsList">List Active Sessions</Link>
              </li>
            </ul>
          </li>
          <li>
