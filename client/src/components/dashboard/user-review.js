...
class UserReview extends Component {
  ...
  componentDidMount() {
    ...
    var userInfo = this.props.cookies.get("user");
    if (userInfo) {
  ...
  render() {
    return (
      <div>
        ...
        <Modal 
          className="modal-container user-review-modal Your-Receipt-modal" 
          show={this.props.showUserReviewModal} 
          onHide={this.close} 
          animation={true} 
          bsSize="small">
          <Modal.Header>
          ...
          <Modal.Body>
            <div className="alert alert-info" style={{ display: this.state.redirectAlert ? "block" : "none" }}>
              {this.props.reviewBy === "User" &&
                "Thank you for submitting your review for your session with " + this.props.reviewModalData.name + ", your review will be visible on Expert's profile soon."}
              {this.props.reviewBy === "Expert" && "Thank you for submitting your review."}
              <p>
                Redirecting you to home page <i className="fa fa-spinner"></i>
              </p>
            </div>
            ...
            <div className="Name_and_details_area">
              <div className="man_img">
                <img src={this.props.reviewModalData.image} alt="" />
              </div>
          ...
          <Modal.Footer>
            <Button className="Submit_comment" bsStyle="success" onClick={this.submitReview}>
              Submit
            </Button>
          </Modal.Footer>
        </Modal>
...
export default connect(null, { saveUserReview })(withCookies(UserReview));
