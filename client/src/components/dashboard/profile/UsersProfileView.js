...
class UsersProfileView extends Component {
	...
	handleSubmit(e){
		...
		if(isValid)
		{
			const {email,firstName,lastName,password,userBio,expertRates,expertCategories,expertContact,expertContactCC,expertRating,expertFocusExpertise,yearsexpertise} = this.state
...
/*							      <option  value="">Select</option>
		                      ...
		                      <div className="col-md-3 form-group">
		                        ...
		                        {/*<input name="expertContactCC" className="form-control" value={this.state.expertContactCC} onChange={this.handleChange} type="number"/>*/}
