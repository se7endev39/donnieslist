...
class UserProfileUpdation extends Component {
      ...
      this.props.fetchMyProfile(id).then(
        (response) => {
          if (response.data.user.role === "Expert") {
            for (let key of this.state.categories) {
              if (key.name === "Music Lessons") {
                for (let newKey of key.subcategory) {
                  console.log(newKey);
                  let name = newKey.name;
                  if (
                    response.data.user.expertCategories[0].match(
                      new RegExp(name, "i")
                    )
                  ) {
          ...
          this.setState({
            userBio: response.data.user.userBio,
            expertRates: response.data.user.expertRates,
            expertCategories: response.data.user.expertCategories[0],
          });
          this.setState({
            expertContact: response.data.user.contact,
            expertRating: response.data.user.expertRating,
            expertFocusExpertise: response.data.user.expertFocusExpertise,
          });
          this.setState({
            yearsexpertise: response.data.user.yearsexpertise,
            password: response.data.user.password,
          });
          this.setState({
            locationCountry: response.data.user.locationCountry,
            locationState: response.data.user.locationState,
            locationCity: response.data.user.locationCity,
          });
          this.setState({ facebookURL: response.data.user.facebookURL });
          this.setState({
            soundcloudURL: response.data.user.soundcloudURL
              ? response.data.user.soundcloudURL
              : "",
          });
          ...
          this.setState({
            expertContactCC: response.data.user.expertContactCC,
          });
  ...
  handleSubmit(e) {
    ...
    if (
      this.state.role === "Expert" &&
      (this.state.resume === "" || this.state.resume === undefined)
    )
      errors.resume = "Resume cant be empty";
    ...
    if (
      this.state.role === "Expert" &&
      (this.state.expertFocusExpertise === "" ||
        this.state.expertFocusExpertise === undefined ||
        this.state.expertFocusExpertise.trim() === "")
    )
      errors.expertFocusExpertise = "Focus Expertise cant be empty";
    if (
      this.state.role === "Expert" &&
      (this.state.yearsexpertise === "" ||
        this.state.yearsexpertise === undefined ||
        this.state.yearsexpertise.trim() === "")
    )
      errors.yearsexpertise = "Experience cant be empty";

    if (!this.state.role === "Expert") {
      if (
        this.state.userBio === "" ||
        this.state.userBio === undefined ||
        this.state.userBio.trim() === ""
      )
        errors.userBio = "User Bio cant be empty";
      if (
        this.state.locationCountry === "" ||
        this.state.locationCountry === undefined ||
        this.state.locationCountry.trim() === ""
      )
        errors.locationCountry = "Country Name cant be empty";
      if (
        this.state.locationState === "" ||
        this.state.locationState === undefined ||
        this.state.locationState.trim() === ""
      )
        errors.locationState = "State Name cant be empty";
      if (
        (this.state.role === "Expert" && this.state.locationCity === "") ||
        this.state.locationCity === undefined ||
        this.state.locationCity.trim() === ""
      )
        errors.locationCity = "City Name cant be empty";
    }
            ...
            (response) => {
              if (response.success) {
                ...
                window.$("html, body").animate(
                  { scrollTop: window.$("#main").offset().top - 5 },
                  1000
                );
  ...
  uploadImage() {
    const { RelatedImages1 } = this.state;
    var formData = new FormData();
    var data = this.state;
                    ...
                    <div className="row">
                      <div className="col-md-3 form-group">
                        ...
                        {this.state.showClickButton === true && (
                          <div className="upload_footer Upload-button">
                            <button
                        ...
                        <div className="col-md-12">
                          ...
                          {!this.state.uploadResume && (
                            <span className="success">
                              {this.state.resume.slice(9)}
                            </span>
                          )}
                          <a
                            href={`${Image_URL}` + this.state.resume}
                            title="Download"
                            download
                      ...
                      {this.state.role && this.state.role === "Expert" && (
                        <div className="row form-group">
                          ...
                          <div className="col-md-4 form-group">
                            ...
                            />
                            <span className="error">
                              {this.state.errors.locationState}
                            </span>
                          </div>
                        </div>
                      )}
                          ...
                          <div className="row form-group">
                            ...
                            <div className="row form-group">
                              <div className="col-md-4 form-group">
                                ...
                                />
                                <span className="error">
                                  {this.state.errors.locationCountry}
                                </span>
                              </div>
                              <div className="col-md-4 form-group">
                                <label>State</label>
                              ...
                              <div className="col-md-4 form-group">
                                ...
                                />
                                <span className="error">
                                  {this.state.errors.locationCity}
                                </span>
                              </div>
                            </div>
                          </div>
                      ...
                      {this.state.role && this.state.role === "Expert" && (
                        <div className="row form-group">
                          ...
                          <div className="col-md-4 form-group">
                            ...
                            />
                            <span className="error">
                              {this.state.errors.expertFocusExpertise}
                            </span>
                          </div>
                          <div className="col-md-4 form-group">
                            ...
                            />
                            <span className="error">
                              {this.state.errors.yearsexpertise}
                            </span>
                          </div>
                        </div>
                      )}
                      ...
                      {this.state.role === "Expert" && (
                        <div className="row ">
                          <a
                            ...
                            onClick={(e) => this.social_modal("facebook")}
                          >
                          ...
                          <a
                            ...
                            onClick={(e) => this.social_modal("linkdin")}
                          >
                          ...
                          <a
                            ...
                            onClick={(e) => this.social_modal("google")}
                          >
                          ...
                          <a
                            ...
                            onClick={(e) => this.social_modal("twitter")}
                          >
                          ...
                          {this.state.isMusician && (
                            <div>
                              <a
                                ...
                                onClick={(e) => this.social_modal("soundcloud")}
                              >
                              ...
                              <a
                                href="#!"
                                className="btn btn-social-icon btn-soundcloud"
                                onClick={(e) => this.social_modal("instagram")}
                              >
                              ...
                              <a
                                ...
                                onClick={(e) => this.social_modal("youtube")}
                              >
                      ...
                      <Modal.Body>
                        ...
                        {this.state.social_link === "Facebook" && (
                          <input
                            ...
                            type="text"
                            value={this.state.facebookURL}
                            onChange={this.setSocialLink.bind(this)}
                          />
                        )}
                        ...
                        {this.state.isMusician &&
                          this.state.social_link === "Soundcloud" && (
                            <input
                              className="form-control"
                              type="text"
                              value={this.state.soundcloudURL}
                        ...
                        {this.state.isMusician &&
                          this.state.social_link === "Instagram" && (
                            <input
                              className="form-control"
                              type="text"
                              value={this.state.instagramURL}
                        ...
                        {this.state.isMusician &&
                          this.state.social_link === "Youtube" && (
                            <input
                              className="form-control"
                              type="text"
                              value={this.state.youtubeURL}
...
export default connect(null, { fetchMyProfile, UpdateMyProfile, logoutUser })(
  withRouter(withCookies(UserProfileUpdation))
);
