...
class UserReview extends Component {
  ...
  submitReview(e) {
    ...
    var expertFullName =
      this.state.expertInfo.profile.firstName +
      " " +
      this.state.expertInfo.profile.lastName;
  ...
  render() {
    return (
      <div>
        ...
        <Modal
          className="modal-container user-review-modal"
        ...
        >
          ...
          <Modal.Body>
            <div
              ...
              style={{ display: this.state.redirectAlert ? "block" : "none" }}
            >
            ...
            <div className="row form-group review_column">
              <div className="col-md-12 col-sm-12 col-lg-12">
                ...
                />
                {/* <Rating
                  onChange={(rate) => this.ratingChange(rate)}
          ...
          <Modal.Footer>
            <Button bsStyle="success" onClick={this.submitReview}>
              Submit
            </Button>
          </Modal.Footer>
        </Modal>
